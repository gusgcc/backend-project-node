...
const Publicacion = model("Publicacion", publicacionSchema)//se creo el modelo User
...
const userDocument = new Publicacion({ email: "correo@gmail.com", nombre: "gustavo" })//una instancia de model es un documento
